...
效果最好莫过于通过代码实现背景，填充颜色纯正，能自动根据屏幕缩放。__Shape__ 样式难以绘制箭头，仅能实现描边和填充颜色，所以最好通过代码实现。
...
源码于2019年1月进行过优化，通过复用实例并调整绘制方式，减少绘制过程对象生成量，最终效果也更精细。但通过开发者模式调试后，个人对多项滚动绘制的性能尚不满意，具体以后会继续优化。