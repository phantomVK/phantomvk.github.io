...
一个包本地类，包含支持64位值动态[条带化](https://en.wikipedia.org/wiki/Data_striping)的类的通用表示和机制。此类集成了 __Number__ 父类，因此具体的子类必须公开这样做。

![Striped64_UML](/img/java/Striped64_UML.png)
 ...
 */
// 通过CAS的方式把cellsBusy值从0改为1，表示成功获取锁
